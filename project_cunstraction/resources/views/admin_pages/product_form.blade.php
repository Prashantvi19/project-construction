...
@section('content')
  <main id="main" class="main">
    ...
    <!-- End Page Title -->
      <div class="card py-3">
    <div class="card-body">
     <form class="container py-3" action="{{url('product_form')}}" method="POST" enctype="multipart/form-data">
      @csrf
      <h2><code>Project ADD</code></h2>
         @if (session('success'))
          ...
          <div class="row mb-3">
            <div class="col-lg-6">
              <div class="form-outline">
                <label class="form-label">Client name & House name</label>
