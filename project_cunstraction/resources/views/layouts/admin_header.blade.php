 ...
 @if(Auth::user())
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{('index1')}}#" class="logo d-flex align-items-center">
        <img src="{{asset('/assets1/img/logo.png')}}" alt="">
        <span class="d-none d-lg-block">Project construction</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img src="{{asset('/assets1/img/messages-1.jpg')}}" alt="" class="rounded-circle">
                <div>
                  <h4>Maria Hudson</h4>
            ...
            <li class="message-item">
              <a href="#">
                <img src="{{asset('/assets1/img/messages-2.jpg')}}" alt="" class="rounded-circle">
                <div>
                  <h4>Anna Nelson</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>6 hrs. ago</p>
            ...
            <li class="message-item">
              <a href="#">
                <img src="{{asset('/assets1/img/messages-3.jpg')}}" alt="" class="rounded-circle">
                <div>
                  <h4>David Muldon</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>8 hrs. ago</p>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">B A</span>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav " id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('product_form')}}">
          <i class="bi bi-journal-text font-size"></i><span>ADD Project</span></i>
        </a>
      </li><!-- End Forms Nav -->

      <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('product_data')}}">
          <i class="bi bi-journal-text font-size"></i><span>Show Project</span></i>
        </a>
      </li><!-- End Forms Nav -->

      <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('service_form')}}">
          <i class="bi bi-journal-text font-size"></i><span>ADD Services</span></i>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('service_data')}}">
          <i class="bi bi-journal-text font-size"></i><span>Show Services</span></i>
        </a>
      </li><!-- End Forms Nav -->
     ...
     <!-- End Change Password Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{('admin_password')}}#">
          <i class="bi bi-person"></i>
          <span>Change Password</span>
        </a>
      </li><!-- End Change Password Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{('/pass_reset')}}#">
          <i class="bi bi-person"></i>
          <span>Reset Password</span>
        </a>
      </li><!-- End Reset Password Nav -->
      <li class="nav-item">
  ...
  <footer  id="footer" class="footer">
    <div class="credits">  
      Designed by <a href="#" target="_blank">Prashant Vishwakarma</a>
    </div>
  </footer><!-- End Footer -->
 @endif
